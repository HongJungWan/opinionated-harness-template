...
| 강제 수준 | 원칙 # |
|---|---|
| 🔒 훅이 차단 | 도메인 순수성(#3) · DIP(#4) · 캡슐화·setter(#11·#18) · 값 객체·이벤트 불변(#16·#20) · 필드 주입 · 도메인 Spring 스테레오타입/`@Transactional`(#3) · 응용→인프라 import(#3·#4) · 도메인 EventPublisher(#3) · 도메인 시간/난수 API 직접 호출 |
